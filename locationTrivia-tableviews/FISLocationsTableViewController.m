...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"locationRID" forIndexPath:indexPath];
    
    // Configure the cell...
    NSInteger row = indexPath.row;
    FISLocation *location = self.locations[row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    FISLocation *locationToPass = self.locations[index];
    triviaTVC.trivia = locationToPass.trivia;
}
